...
def generate_via_router(messages: List[Dict[str, str]], model_hint: str | None = None,
    ...
    r = requests.post(f"{INFERENCE_ROUTER_URL}/v1/generate", json=payload, timeout=INFERENCE_TIMEOUT_S)
    r.raise_for_status()
    return r.json()